    ...
    return (
        <header className='w-full h-[60px] flex justify-between items-center mb-4 border-b px-4'>
            ...
            <div className="flex justify-start items-center gap-2">
                ...
                <strong>STEMPS</strong>
            </div>

            <div className="flex justify-between items-center md:w-1/2 max-md:hidden">
                <nav className="">
            ...
            <button className="rounded text-white px-2 py-1 md:hidden bg-[#121212]">Меню</button>
